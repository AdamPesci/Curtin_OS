...
/* linked_list.h 
*
* This file contains the method declarations used for linked list.c
* 
* This linked list was previously submitted for curtin colleges 2018 Sem2 UCP assignment
* Since then, some alterations have been made
...
/*
*TYPEDEF:Struct Data 
*FIELDS: Data: void pointer to some data to be stored in the list 
*/
typedef struct Data
{
    void *data;
...
/*
*TYPEDEF:Struct Node 
*FIELDS: Value: A Data_t struct that stores some data
...
/*
*IMPORTS: LinkedList_t *linkedList: (reference to a linked list)
